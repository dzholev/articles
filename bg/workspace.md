...
__Критерий 3*:__ Ползване на един монитор.

Работа дълго време с глава, завъртяна настрани, може да се получи и когато монитора е много широк. Трудно може да се даде абсолютна стойност за това, кога размера на монитора е прекалено голям, понеже различните хора седят на различно разстояние, имат различно възприятие и съответно могат да ползват малко по-големи или по-малки монитори, при които главата да не трябва да се завърта при четене на текст от монитора. При мен, оптималният размер е около 24-25 инча. В момента ползвам 27 инчов монитор и при него, за да чета нещо в двата края на монитора, трябва да завъртя главата си.

**Критерий 4:** Размер на монитора, при който главата не трябва да се завърта когато се чете текст от единия край до другия край на монитора.
